...
parser.add_argument('x', help='Data encoded in an ASCII hex format (ie. ABC would be 414243)')
parser.add_argument('k', help='Data encoded in an ASCII hex format (ie. ABC would be 414243)')
args = parser.parse_args()

s1 = base64.b64encode(args.x.encode()).decode() 
#base64.b64encode(args.x.encode()).decode()
s2 = base64.b64encode(args.k.encode()).decode()
#base64.b64encode(args.k.encode()).decode()
